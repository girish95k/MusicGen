...
def GetOptions():
    ...
    parser.add_option("-r"
                     ...
                     ,default="0"
                     ,dest="raaga"
                     ,help="0 for Mohanam, 1 for Shankarabaranam, 2 for Hamsadhwani")
    ...
    return (file_handles, options.qpm, options.output_filename, options.octave, options.num_notes, options.width, options.output_score_file, options.pysynth_module, options.raaga)
